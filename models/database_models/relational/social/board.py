...
from sqlalchemy.dialects.postgresql import VARCHAR, TIMESTAMP, UUID, SMALLINT
...
class Board(TableBase):
  ...
  board_id: Mapped[PyUUID] = Column(UUID(as_uuid=True), primary_key=True, unique=True, index=True, nullable=False,
